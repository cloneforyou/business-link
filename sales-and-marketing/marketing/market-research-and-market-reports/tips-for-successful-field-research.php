...
<head>
	<title>Tips for successful field research | Business Link</title>
	<?php include $_SERVER['DOCUMENT_ROOT'].'/_inc/meta.php'; ?>
	<!-- ref: .html || /detail?itemId=1073790741&type=RESOURCES -->
	<meta name="keywords" content="Key points to remember when designing your field research and interpreting your results" />
...
<div class="row">
	<div class="small-12 large-8 large-push-4 columns">
		...
		<h2>Tips for successful field research</h2>
		...
		<h3>Talk to enough people</h3>
		<p>A survey, for example, of two people won't get you enough information. Some market research professionals suggest asking at least 150 people in order to get a complete picture.</p>
		
		<h3>Keep research impartial</h3>
		<p>It's easy to encourage people to give the answer you want. For example, by asking leading questions or smiling at the 'right' answer. Discussions, where you're not working from a list of set questions, are particularly easy to distort. And in a focus group, individuals with strong opinions may influence the views of others.</p>
		
		<h3>Interpret results with care</h3>
		<p>You need to make sure you draw the right conclusions from your research. Bear in mind that people may distort answers in the hope of affecting what you do. For example, they might say they would be interested in a product "if the price was lower". Qualitative research - where you're investigating feelings and attitudes - can be particularly difficult to interpret.</p>
