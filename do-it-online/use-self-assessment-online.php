...
<div id="content" > 
	...
	<!-- Page breadcrumb -->
	<div id="breadcrumb">
		<p><a href="index.php">Home</a> &gt; <a href="/do-it-online.php">Do it online</a> &gt; Use Self Assessment Online</p>
	</div>
	...
	<div id="allcontent">
		<div>
			<div id="maincontent">
				...
				<p><a href="http://customs.hmrc.gov.uk/channelsPortalWebApp/channelsPortalWebApp.portal?_nfpb=true&_pageLabel=pageOnlineServices_ShowContent&propertyType=document&id=HMCE_MIG_009921#P155_10104" title="Service availability" rel="external">Check the availability of HMRC's Online Services<span> - Opens in a new window</span></a>.</p>
				<h3>Related guidance</h3>
				<p>See our section on <a href="/tax-payroll-and-company-information/self-assessment.php.html">Self Assessment</a>.</p>
				<h3>Disclaimer</h3>
				<p>Please note that HMRC's terms and conditions will apply when using Self Assessment Online.</p>
			</div>
