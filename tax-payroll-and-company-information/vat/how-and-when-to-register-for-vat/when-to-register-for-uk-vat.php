...
<html class="no-js">
<head>
	<title>When to register for UK VAT | Business Link</title>
...
<div class="row">
	<div class="small-12 large-8 large-push-4 columns">
		...
		<h1>When to register for UK VAT </h1>
		<h2>Introduction</h2>
		<img src="../../../_img/TR0110.gif" width="94" height="62" alt="" />
		<p>If you're unsure about whether to register for VAT, this guide will help to answer many of your questions. It explains when you must register and also when you can register voluntarily, and why you might benefit from voluntary registration.</p>
		<p>It also explains:</p>
		<ul>
			<li>the circumstances in which you don't need to register</li>
			<li>the circumstances in which you cannot register</li>
			<li>when to register if you do business internationally</li>
		</ul>
		
		<ul>
			<li><a href="/tax-payroll-and-company-information/vat/how-and-when-to-register-for-vat/when-to-register-for-uk-vat/who-can-and-cannot-register-for-vat.php" title="Who can and cannot register for VAT">Next</a></li>
		</ul>
