...
<div class="row">
	<div class="small-12 large-8 large-push-4 columns">
		...
		<h2>Introduction</h2>
		<span><img src="/_img/DTree_tax_accounts.gif" width="78" height="118" alt="Accounts" /></span>
		...
		<p><strong>Print options</strong> - <a href="#">What are my print options <img src="/_img/whatisthis.gif" width="9" height="11" alt="" /></a></p>
		<ul>
			<li><a href="#">Print guide now</a></li>
			<li><a href="#">Add guide to my print portfolio (print later as PDF)</a></li>
		</ul>
		<p><strong>Email options</strong> - <a href="#">What are my email options <img src="/_img/whatisthis.gif" width="9" height="11" alt="" /></a></p>
		<ul>
