<li data-accordion-item>
	...
	<ul>
					...
					<ul>
						...
						<li>
							...
							<ul>
								...
								<li>Raising finance through asset securitisation</li>
							</ul>
						</li>
						<li>
						...
						<li>
							...
							<ul>
								...
								<li>Recourse factoring and non-recourse factoring</li>
								<li>Invoice discounting</li>
								<li>The cost of factoring and invoice discounting</li>
								<li>Export factoring</li>
								<li>How to choose a factor</li>
								<li>Supplier finance</li>
								<li>Here's how debt factoring improved my cashflow</li>
							</ul>
						</li>
						<li>
					...
					<ul>
						...
						<li>
							...
							<ul>
								...
								<li>Securing equity finance - preparation</li>
								<li>Securing equity finance - the pitch</li>
							</ul>
						</li>
						<li>
							...
							<ul>
								...
								<li>Sale and transfer of shares</li>
								<li>Paying dividends and paying tax</li>
								<li>Making changes to share capital</li>
								<li>Here's how I managed the shareholders in my business</li>
							</ul>
						</li>
						<li>
						...
						<li>
							...
							<ul>
								...
								<li>Disadvantages of listing on the London Stock Exchange Main Market</li>
								<li>Regulatory requirements for joining the London Stock Exchange Main Market</li>
								<li>How to list a business on the London Stock Exchange Main Market</li>
								<li>London Stock Exchange Main Market listing types and routes</li>
								<li>How shares are traded on the London Stock Exchange Main Market</li>
							</ul>
						</li>
						<li>
							...
							<ul>
								...
								<li>Disadvantages of joining the Alternative Investment Market</li>
								<li>Legal requirements for Alternative Investment Market listing</li>
								<li>How to list a business on the Alternative Investment Market</li>
								<li>Nominated Adviser roles and responsibilities</li>
							</ul>
						</li>
					</ul>
				</li>
					...
					<ul>
						...
						<li>
							...
							<ul>
								...
								<li>Skills and training for better business performance</li>
								<li>Support for exporting and overseas investment</li>
								<li>Support to help the environment and reduce costs</li>
							</ul>
						</li>
						<li>
						...
						<li>
							...
							<ul>
								...
								<li>Business innovation centres</li>
								<li>Science parks</li>
								<li>Chambers of Commerce</li>
								<li>Assisted areas</li>
								<li>Business clusters</li>
								<li>The Small Business Research Initiative</li>
							</ul>
						</li>
						<li>
							...
							<ul>
								...
								<li>Take your invention to market</li>
								<li>Get support from other inventors</li>
								<li>Help developing your idea</li>
								<li>Find manufacturers to build a prototype</li>
								<li>Attract funding for your invention</li>
								<li>Here's how I got support for my invention</li>
							</ul>
						</li>
						<li>
							...
							<ul>
								...
								<li>Knowledge Transfer Networks</li>
								<li>University Innovation Centres</li>
								<li>Collaborative Research &amp; Development</li>
								<li>The Step Programme</li>
								<li>Here's how I used a Knowledge Transfer Partnership and worked with a university</li>
							</ul>
						</li>
					</ul>
				</li>
					...
					<ul>
						...
						<li>
							...
							<ul>
								...
								<li>How to know when your customers are in trouble</li>
							</ul>
						</li>
						<li>
					...
					<ul>
						...
						<li>
							...
							<ul>
								...
								<li>How to make your business more efficient</li>
								<li>How you can improve your profitability</li>
								<li>How to close down your business</li>
								<li>Here's how I turned my business around in difficult circumstances (Flash video)</li>
							</ul>
						</li>
					</ul>
				</li>
			...
			<ul>
				...
				<li>
					...
					<ul>
						...
						<li><a href="/finance-and-grants/financial-planning-and-accounts/financial-and-management-accounts-the-basics/financial-accounts.php">Financial accounts</a></li>
						<li><a href="/finance-and-grants/financial-planning-and-accounts/financial-and-management-accounts-the-basics/filing-financial-accounts.php">Filing financial accounts</a></li>
						<li><a href="/finance-and-grants/financial-planning-and-accounts/financial-and-management-accounts-the-basics/management-accounts.php">Management accounts</a></li>
						<li><a href="/finance-and-grants/financial-planning-and-accounts/financial-and-management-accounts-the-basics/uses-of-management-accounting.php">Uses of management accounting</a></li>
						<li><a href="/finance-and-grants/financial-planning-and-accounts/financial-and-management-accounts-the-basics/the-importance-of-maintaining-accurate-accounts.php">The importance of maintaining accurate accounts</a></li>
				...
				<li>
					...
					<ul>
						...
						<li>The purchase ledger</li>
						<li>The wages book</li>
						<li>Computerising financial records</li>
						<li>Hints and tips</li>
						<li>Here's how I established an effective record-keeping system</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>Discounting future cashflow</li>
						<li>Net present value and internal rate of return</li>
						<li>Investment risk and sensitivity analysis</li>
						<li>Help with investment appraisal</li>
						<li>Non-financial factors for investment appraisal</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						<li><a href="/finance-and-grants/financial-planning-and-accounts/identify-which-vat-scheme-your-business-is-eligible-to-use.php" title="Identify which VAT scheme your business is eligible to use">Introduction</a></li>
				...
				<li>
					<a href="http://webarchive.nationalarchives.gov.uk/20111206102534/http://www.businesslink.gov.uk/static/html/intro.html">Avoid the problems of overtrading</a>
					<ul>
						<li><a href="http://webarchive.nationalarchives.gov.uk/20111206102534/http://www.businesslink.gov.uk/static/html/intro.html" title="Avoid the problems of overtrading">Introduction</a></li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>Getting the right staffing levels</li>
						<li>Boost your business all year round</li>
						<li>Make the best use of quieter periods</li>
						<li>Tax and benefits issues for seasonal businesses</li>
						<li>Here's how I made my seasonal business successful</li>
					</ul>
				</li>
				<li>
					<a href="/buy-or-sell-a-business/businesses-in-difficulty/assess-your-business-performance.php">Assess your business' performance</a>
				...
				<li>
					...
					<ul>
						...
						<li>The basic state pension</li>
						<li>Stakeholder pensions</li>
						<li>Other pension products</li>
						<li>Other tax-efficient savings - ISAs</li>
						<li>Transferring your pension</li>
						<li>Keeping track of your pension</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>Exit option: family succession</li>
						<li>Exit option: selling your business</li>
						<li>Exit option: float your business</li>
						<li>Exit option: close your business</li>
						<li>The exit process</li>
						<li>Here's how I planned an exit strategy</li>
					</ul>
				</li>
				<li>
					<a href="/finance-and-grants/financial-planning-and-accounts/choose-and-work-with-an-accountant.php">Choose and work with an accountant</a>
					<ul>
						...
						<li><a href="/finance-and-grants/financial-planning-and-accounts/choose-and-work-with-an-accountant/managing-the-relationship-with-your-accountant.php">Managing the relationship with your accountant</a></li>
						<!-- //
						<li><a href="http://webarchive.nationalarchives.gov.uk/20111219170628/http://www.businesslink.gov.uk/bdotg/action/detail?itemId=1075063599&r.l1=1073858790&r.l2=1073858944&r.l3=1073963622&r.s=m&type=CASE%20STUDIES">Here's how I used an accountant to help me in my business</a></li>
						// -->
					</ul>
				</li>
			</ul>
			...
			<ul>
				...
				<li>
					...
					<ul>
						...
						<li>Manage income and expenditure</li>
						<li>Cashflow problems and how to avoid them</li>
						<li>Using your cashflow forecast as a business tool</li>
				...
				<li>
					...
					<ul>
						...
						<li>Keep business forecasts up to date</li>
						<li>Be aware of changing market conditions</li>
						<li>Your relationship with banks and other lenders</li>
						<li>Signs of customers in trouble: hard evidence</li>
					</ul>
				</li>
				<li>
				...
				<li>
					...
					<ul>
						...
						<li>Setting levels of credit</li>
						<li>Reducing the risk of late or non-payment</li>
						<li>Paying other businesses on time</li>
					</ul>
				</li>
				<li>
		...
		<li>
			...
			<ul>
				<li><a href="/finance-and-grants/managing-suppliers-and-payments.php" title="Managing suppliers and payments">Introduction</a></li>
				<li>
					<a href="/grow-your-business/growth-through-strategic-sourcing/manage-your-suppliers.php">Manage your suppliers</a>
					<ul>
						<li><a href="/grow-your-business/growth-through-strategic-sourcing/manage-your-suppliers.php" title="Manage your suppliers">Introduction</a></li>
						...
						<li>Using technology to improve your supply chain efficiency</li>
						<li>Drawing up service level agreements with suppliers</li>
						<li>Reviewing your suppliers&#39; performance</li>
						<li>Ending supplier contracts</li>
						<li>Here&#39;s how I reduced supplier costs</li>
					</ul>
				</li>
				<li>
					<a href="/finance-and-grants/manage-your-cashflow/invoicing-and-payment-terms.php">Invoicing and payment terms</a>
				...
				<li>
					...
					<ul>
						...
						<li>Assess the risk level for overseas payments</li>
						<li>Managing your overseas customers&#39; payment performance</li>
						<li>Insurance against non-payment by overseas customers</li>
					</ul>
				</li>
				<li>
		...
		<li>
			...
			<ul>
				<li><a href="/finance-and-grants/debt-recovery.php" title="Debt recovery">Introduction</a></li>
				<li>
					<a href="/finance-and-grants/debt-recovery/ensuring-customers-pay-you-on-time.php">Ensuring customers pay you on time</a>
					<ul>
						<li><a href="/finance-and-grants/debt-recovery/ensuring-customers-pay-you-on-time.php" title="Ensuring customers pay you on time">Introduction</a></li>
				...
				<li>
					...
					<ul>
						...
						<li>Bona vacantia rules and regulations for the Treasury Solicitor</li>
						<li>How to contact the Treasury Solicitor&#39;s Bona Vacantia Division</li>
					</ul>
				</li>
				<li>
				...
				<li>
					...
					<ul>
						...
						<li>Proof of serving a statutory demand</li>
						<li>What to do if you are served with a statutory demand</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>Debt advice from your bank</li>
						<li>Debt counsellors</li>
						<li>Winding up, bankruptcy, receivership and administration</li>
						<li>Individual voluntary arrangement</li>
						<li>Negotiating debt restructure</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>How to make a court claim</li>
						<li>After a court claim has been issued and served</li>
						<li>A contested court case</li>
						<li>Recovering interest on unpaid debts</li>
						<li>Enforcing the judgment</li>
						<li>Winding up and bankruptcy petitions</li>
						<li>Recovering debt from another European Union member state</li>
						<li>Here&#39;s how I recovered a debt using the law</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>Is Money Claim Online secure?</li>
						<li>Using Money Claim Online to issue or respond to a claim</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>How to use Possession Claim Online</li>
						<li>Useful links for Possession Claim Online</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>Creditors&#39; meetings and creditors&#39;/liquidation committees</li>
						<li>Conduct and voting at creditors&#39; meetings</li>
						<li>Completion of bankruptcy and company liquidation cases</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>What happens after someone is declared bankrupt</li>
					</ul>
				</li>
				<li>
			...
			<ul>
				...
				<li>
					...
					<ul>
						...
						<li>What happens to domain names owned by dissolved companies</li>
						<li>The statutory power of disclaimer</li>
						<li>Jurisdiction for dealing with assets of dissolved companies</li>
						<li>Assets of clubs and societies in bona vacantia</li>
						<li>Information required for assets of dissolved societies</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>Statutory Declarations and what to include for companies that can be restored</li>
						<li>Proof of identity needed for grant applications where a dissolved company can be restored</li>
						<li>What happens when the Treasury Solicitor makes a discretionary grant where a dissolved company can be restored</li>
						<li>Information required for applying for a discretionary grant</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>How the Treasury Solicitor determines who receives discretionary grants</li>
						<li>Statutory Declarations and what to include for companies that cannot be restored</li>
						<li>Proof of identity for grant applications where a dissolved company cannot be restored</li>
						<li>What happens when the Treasury Solicitor makes a discretionary grant where a dissolved company cannot be restored</li>
						<li>Information required when applying for a discretionary grant</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>Taking professional advice on bona vacantia</li>
						<li>Information required by the Treasury Solicitor for dissolved company's shares</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>Valuing the 'ownerless' land or buildings</li>
						<li>How to buy 'ownerless' land or buildings</li>
						<li>What happens when the Treasury Solicitor disclaims 'ownerless' land and buildings</li>
						<li>Information required by the Treasury Solicitor for the purchase of 'ownerless' land and buildings</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>How freehold title purchase prices are calculated</li>
						<li>What happens when the Treasury Solicitor gives up its right to freehold property</li>
						<li>Information required when buying a freehold reversion</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<Li>How headlease title purchase prices are calculated</Li>
						<li>What happens when the Treasury Solicitor gives up its claim to the headlease of a residential property</li>
						<li>Information required for buying a headlease</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>Information required by the Treasury Solicitor for disclaiming property</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>How the lender's ability to pursue recovery may be limited</li>
						<li>Information required by the Treasury Solicitor</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>Information required by the Treasury Solicitor for dissolved company's intellectual property rights</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>Professional advice for dealing with ownerless trade marks</li>
						<li>Information required by the Treasury Solicitor for a dissolved company's trade marks</li>
					</ul>
				</li>
				<li>
				...
				<li>
					...
					<ul>
						...
						<li>Information required for selling bona vacantia as a mortgagee</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>Sale of ownerless intellectual property and rights</li>
						<li>Sale of ownerless shares</li>
						<li>The Treasury Solicitor's legal costs, disbursements and fixed charges</li>
					</ul>
				</li>
				<li>
				...
				<li>
					...
					<ul>
						...
						<li>Share capital distribution limit for dissolved companies</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>Information required for the sale of copyright as bona vacantia</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>How long does the application for a waiver letter take?</li>
					</ul>
				</li>
			</ul>
		</li>
