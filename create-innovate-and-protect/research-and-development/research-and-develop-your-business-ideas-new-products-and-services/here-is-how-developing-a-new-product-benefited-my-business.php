...
<html>
<head>
	<title>Here's how developing a new product benefited my business | Business Link</title>
...
<div class="row">
	<div class="small-12 large-8 large-push-4 columns">
		...
		<h1>Here's how developing a new product benefited my business</h1>
		<h2>Here's how developing a new product benefited my business</h2>
		<p>WOW Toys was formed in 1997 by toy maker Nadim Ednan-Laperouse and is based in Fulham, London. The company designs and supplies multi functional toys that don't need batteries for children aged 0-5 years. They currently sell to over 400 retail outlets in the UK and export their products to 36 countries around the world.</p>
		<p>Here Nadim talks about the value of new product development, and how it has benefited his business.</p>
		...
		<ul>
			<li><a href="../../../_flash/eyi_new_product_transcript.txt">Read transcript</a></li>
			<li><a title="Play the audio only version of this video" href="../../../_flash/eyi_new_product_audio.mp3">Listen to audio only (mp3, 13MB)</a></li>
			<li><a href="/video-and-e-learning-help.php">Help</a></li>
		</ul>

		<ul>
			<li><a href="/create-innovate-and-protect/research-and-development/research-and-develop-your-business-ideas-new-products-and-services/here-is-how-developing-a-new-product-benefited-my-business.php" title="Here's how I got my great new product in front of customers">Prev</a></li>
		</ul>
		...
		<div class="media-object stack-for-small">
			<div class="media-object-section">
				<div class="thumbnail">
					<img src="../../../_img/Copy_of_wow.jpg" width="181" height="121" border="0" alt="" />
				</div>
			</div>
			<div class="media-object-section">
				<h3>
					Nadim Ednan-Laperouse<br />
					<a href="http://www.wowtoys.com/" target="_blank" rel="noopener noreferrer">WOW Toys</a><br />
					Nadim's top tips:
				</h3>
				<ul>
					<li>"Never be afraid of the seemingly unknown. Dream the future and then reach out to grasp it with both hands!"</li>
					<li>"You must have a plan and a clear timeline of the events/decisions that you need to make from beginning to end."</li>
					<li>"New product development demands financing and not only is it necessary to have the cash, but also to understand the expected return on investment."</li>
				</ul>
			</div>
		</div>
