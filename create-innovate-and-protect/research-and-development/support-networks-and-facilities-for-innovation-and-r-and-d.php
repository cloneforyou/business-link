...
<head>
	<title>Support networks and facilities for innovation and R&amp;D | Business Link</title>
	<?php include $_SERVER['DOCUMENT_ROOT'].'/_inc/meta.php'; ?>

	<!-- ref: layer4735.html || /layer?topicId=1074417980 -->
	<meta name="description" content="Enterprise organisations and groups that can help your business with innovation, research and development" />
...
<div class="row">
	<div class="small-12 large-8 large-push-4 columns">
		...
		<img src="/_img/NP1040.gif" width="94" height="62"  alt="" />

		<p>Business success is often driven by innovation. In the UK a wide range of initiatives are available to help small businesses make the most of their research and development programmes.</p>
		<p>Schemes and networks supported by the government offer businesses access to expert advice from specialist organisations as well as other businesses. These include Chambers of Commerce and the Enterprise Europe Network as well as a number of online networks.</p>
		<p>As location can also be a vital factor in the success of your business, science parks and assisted areas have been established to help companies grow and to promote science and technology.</p>
		<p>This guide explains what support is available to businesses. It covers schemes and networks that provide practical advice or that can put you in touch with others that can help. It also explains how science parks and similar environments work and how they could benefit your business.</p>
		
		<ul>
			<li><a href="/create-innovate-and-protect/research-and-development/support-networks-and-facilities-for-innovation-and-r-and-d/knowledge-transfer-support.php" title="Knowledge Transfer Support">Next</a></li>
		</ul>
