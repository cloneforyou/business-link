...
<head>
	<title>Chambers of Commerce | Business Link</title>
	<?php include $_SERVER['DOCUMENT_ROOT'].'/_inc/meta.php'; ?>

	<!-- ref: x__x || /detail?itemId=1074419547&type=RESOURCES -->
	<meta name="description" content="Find and access support services offered by local Chambers of Commerce" />
...
<div class="row">
	<div class="small-12 large-8 large-push-4 columns">
		...
		<p>The British Chambers of Commerce form a network of 100 quality-accredited chambers throughout the UK.</p>
		<p>Becoming a member of a chamber gives a business access to services such as:</p>
		<ul>
			<li>training</li>
			<li>information</li>
			<li>resources</li>
			<li>networking</li>
			<li>savings on essential overheads</li>
		</ul>

		<p>Some services are available online. Larger chambers may offer schemes to encourage innovation and foster best practice. Many areas also have more informal networks, some supporting particular industries.</p>
		<p>You can <a href="http://www.britishchambers.org.uk/find-your-chamber/" target="_blank" rel="noopener noreferrer">find Chambers of Commerce in your area on the British Chambers of Commerce website</a>.</p>
		<p>You can also <a href="https://web.archive.org/web/20120605130329/https://web.archive.org/web/20120605130329/http://www.bfora.net/default.asp" target="_blank" rel="noopener noreferrer">find business networks on the bFORA website</a>.</p>
		
		<ul>
			<li><a href="/create-innovate-and-protect/research-and-development/support-networks-and-facilities-for-innovation-and-r-and-d/science-parks.php" title="Science parks">Prev</a></li>
			<li><a href="/create-innovate-and-protect/research-and-development/support-networks-and-facilities-for-innovation-and-r-and-d/assisted-areas.php" title="Assisted areas">Next</a></li>
		</ul>
		...
		<h3>Actions</h3>
		<ul>
			<li><a href="http://www.britishchambers.org.uk/find-your-chamber/" target="_blank" rel="noopener noreferrer">Local Chamber of Commerce contact details on the British Chambers of Commerce website</a></li>
			<li><a href="https://web.archive.org/web/20120605130329/https://web.archive.org/web/20120605130329/http://www.bfora.net/default.asp" target="_blank" rel="noopener noreferrer">Business networks on the bFORA website</a></li>
		</ul>
