...
<head>
	<title>Virtual support networks | Business Link</title>
...
<div class="row">
	<div class="small-12 large-8 large-push-4 columns">
		...
		<h2>Virtual support networks</h2>
		<p>Virtual support networks exist online to enable businesses to interact and to share ideas and tips for progressing. They can help you to contact other businesses or organisations within your own specialism or area of expertise that you might otherwise have been unaware of or have been unable to connect with.</p>
		<p>There are a number of virtual business support websites available, which enable people involved in research and development to access other businesses for support and mutual advice.</p>
		<p>Some businesses may prefer to create their own business network for their specialism or industry. There are organisations online that can help you to set up your own e-community, using their contacts and technical expertise. 
			<!-- Link no goes to porn!
			 <a href="http://www.vbnonline.com/build" target="bgExternalonlinebusinesslinkgovuk" title="Virtual support network information">Find out about creating an e-community yourself on the Virtual Business Network (VBN) website</a>. -->
		</p>
		<p>There are websites offering mutual support in specific industry sectors. These include Business Innovation Link (BIL) which provides Northern Ireland's inventors and innovators with assistance for new product ideas and the Innovator's Counselling and Advisory Service for Scotland (ICASS), which provides specialist advice and support for inventors and innovative companies.</p>
		<p>You can:</p>
		<ul>
			<li>
				<a href="https://www.investni.com/" target="_blank" rel="noopener noreferrer">find information for businesses in Northern Ireland on the InvestNI website</a>
			</li>
			<!-- <li><a href="http://www.icass.co.uk/" target="bgExternalonlinebusinesslinkgovuk" title="Advice on the protection, development and commercial exploitation of innovative ideas and inventions">find advice and information for businesses in Scotland on the ICASS website</a></li> -->
		</ul>
		
		<ul>
			<li><a href="/create-innovate-and-protect/research-and-development/support-networks-and-facilities-for-innovation-and-r-and-d/knowledge-transfer-support.php" title="Knowledge Transfer Support">Prev</a></li>
			<li><a href="/create-innovate-and-protect/research-and-development/support-networks-and-facilities-for-innovation-and-r-and-d/the-enterprise-europe-network.php" title="The Enterprise Europe Network">Next</a></li>
		</ul>
		...
		<!-- <h3>Actions</h3>
		<ul>
			<li><a href="http://www.vbnonline.com/build" target="bgExternalonlinebusinesslinkgovuk" title="Virtual support network information">Virtual support network information on the VBN website</a></li>
		</ul> -->
