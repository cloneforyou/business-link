...
<head>
	<title>Business clusters | Business Link</title>
	<?php include $_SERVER['DOCUMENT_ROOT'].'/_inc/meta.php'; ?>

	<!-- ref: x__x || /detail?itemId=1084674502&type=RESOURCES -->
	<meta name="description" content="Support and benefits of locating your business in a cluster zone" />
...
<div class="row">
	<div class="small-12 large-8 large-push-4 columns">
		...
		<p>The success of an industry in a particular geographical area might not just be related to the cost of production. For example, businesses can benefit from the presence of local expertise, a pool of skilled labour, or research and development facilities. The cluster concept aims to build on this idea.</p>
		<p>Clusters are geographically close, interconnected companies and specialised suppliers within certain fields that work and co-operate with each other, as well as being competitors.</p>
		<p>Support for these clusters includes helping companies access a skilled workforce, quality universities, good sites and investment capital. Growth in these clusters also attracts suitable suppliers and even customers to the area. <a href="http://webarchive.nationalarchives.gov.uk/20120903211434/http://webarchive.nationalarchives.gov.uk/20120903211434/http://www.bis.gov.uk/policies/economic-development/clusters-in-the-uk" target="_blank" rel="noopener noreferrer">Read about business clusters on the Department for Business, Energy &amp; Industrial Strategy (BIS) website</a>.</p>
		
		<ul>
			<li><a href="/create-innovate-and-protect/research-and-development/support-networks-and-facilities-for-innovation-and-r-and-d/assisted-areas.php" title="Assisted areas">Prev</a></li>
			<li><a href="/create-innovate-and-protect/research-and-development/support-networks-and-facilities-for-innovation-and-r-and-d/the-small-business-research-initiative.php" title="The Small Business Research Initiative">Next</a></li>
		</ul>
		...
		<h3>Actions</h3>
		<ul>
			<li><a href="http://webarchive.nationalarchives.gov.uk/20120903211434/http://webarchive.nationalarchives.gov.uk/20120903211434/http://www.bis.gov.uk/policies/economic-development/clusters-in-the-uk" target="_blank" rel="noopener noreferrer">Business clusters information on the BIS website</a></li>
		</ul>
