...
<head>
	<title>Business mentoring and other types of advice | Business Link</title>
	<?php include $_SERVER['DOCUMENT_ROOT'].'/_inc/meta.php'; ?>

	<!-- ref: detail98b8.html || /detail?itemId=1084721663&type=RESOURCES -->
	<meta name="description" lang="en" content="Building on your business mentoring support through coaching, networking, peer mentoring and learning alliances" />
...
<body>
	...
	<div class="row">
		<div class="small-12 large-8 large-push-4 columns">
			...
			<h2>Business mentoring and other types of advice</h2>
			<p>Using a business mentor is one way of helping you make the right decisions for your business, but there are other forms of support you could consider. These include:</p>
			<ul>
				<li>coaching</li>
				<li>peer mentoring and peer learning alliances</li>
				<li>networking</li>
				<li>professional advice</li>
			</ul>

			<h3>Coaching</h3>
			<p>Specific short-term business issues can be addressed through coaching which has similar elements as mentoring. There are many organisations that offer coaching services.</p>
			
			<h3>Peer mentoring and peer learning alliances</h3>
			<p>You can also get help or advice from other people in a similar situation, such as people of a similar age or background. When setting up a business, this is likely to involve contacting someone who is also trying to set up a business and faces similar issues. Like business mentoring, this can be as formal or informal as you like.</p>
			...
			<ul>
				<li><a href="/starting-up/further-support-for-your-business/the-benefits-of-business-mentoring/online-business-mentoring.php" title="Online business mentoring">Prev</a></li>
				<li><a href="/starting-up/further-support-for-your-business/the-benefits-of-business-mentoring/becoming-a-business-mentor.php" title="Becoming a business mentor">Next</a></li>
			</ul>
			...
			<ul>
				...
				<li>Business mentoring and other types of advice</li>
