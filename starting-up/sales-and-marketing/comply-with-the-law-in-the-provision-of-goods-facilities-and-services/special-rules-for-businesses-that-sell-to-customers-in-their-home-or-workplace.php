...
<html class="no-js">
<head>
	<title>Special rules for businesses that sell to customers in their home or workplace | Business Link</title>
	<?php include $_SERVER['DOCUMENT_ROOT'].'/_inc/meta.php'; ?>

	<!-- ref: detail71ba.html || /detail?itemId=1073792519&type=RESOURCES -->
	<meta name="description" lang="en" content="Information on the regulations you must comply with if you sell products or services online" />
...
<div class="row">
	<div class="small-12 large-8 large-push-4 columns">
		...
		<ul>
			...
			<li>details of membership of any professional organisations</li>
			<li>an opportunity to correct orders before they are completed</li>
		</ul>
		...
		<ul>
			<li><a href="/starting-up/sales-and-marketing/comply-with-the-law-in-the-provision-of-goods-facilities-and-services/rules-for-businesses-that-dont-sell-to-customers-face-to-face.php" title="Rules for businesses that don't sell to customers face to face">Prev</a></li>
			<li><a href="/starting-up/sales-and-marketing/comply-with-the-law-in-the-provision-of-goods-facilities-and-services/special-rules-for-businesses-that-sell-electronic-and-electrical-goods.php" title="Special rules for businesses that sell electronic and electrical goods">Next</a></li>
		</ul>
		...
		<ul>
			...
			<li>Special rules for businesses that sell to customers in their home or workplace</li>
