...
<html>
<head>
	<title>Common mistakes when starting up - and how to avoid them | Business Link</title>
	<?php include $_SERVER['DOCUMENT_ROOT'].'/_inc/meta.php'; ?>

	<!-- ref: layer937d.html || /layer?topicId=1075219484 -->
	<meta name="description" lang="en" content="Learn about and avoid the most frequent mistakes made by new business owners" />
...
<div class="row">
	<div class="small-12 large-8 large-push-4 columns">
				...
				<h2>Introduction</h2>
				<img src="../../_img/common_mistakes%20no2.jpg" width="94" height="62" border="0" alt="" />
				<p>Launching a small business can be risky and success is not always guaranteed. Businesses are most vulnerable to failure during the early years of trading, with 20 per cent of new businesses folding within their first year and 50 per cent within their first three years.</p>
				<p>These figures should not scare you off, but should prepare you for some of the challenges entrepreneurs face when starting a business. With hard work and an awareness of the issues, a new business can be a great success.</p>
				<p>This guide looks at the most common mistakes new business owners make and, more importantly, how you can avoid them. It also shows you how to improve the chances of your business idea succeeding.</p>
				
				<ul>
					<li><a href="/starting-up/considering-starting-up/common-mistakes-when-starting-up-and-how-to-avoid-them/poor-or-inadequate-market-research.php" title="Poor or inadequate market research">Next</a></li>
				</ul>
