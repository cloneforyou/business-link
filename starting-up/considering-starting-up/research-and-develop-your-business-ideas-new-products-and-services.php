...
<div class="row">
	<div class="small-12 large-8 large-push-4 columns">
		...
		<p>It also has tips on how to finance the development of your idea and how to protect it if other people get involved.</p>
		<p>You will also find information on the development process for new products or services, which will help you to make practical investment and budgeting decisions. This guide also advises you on how best to create a product development team and manage a project.</p>
		
		<ul>
			<li><a href="/create-innovate-and-protect/research-and-development/research-and-develop-your-business-ideas-new-products-and-services/finding-and-developing-your-idea-and-new-products-and-services.php" title="Finding and developing your idea and new products and services">Next</a></li>
		</ul>
		...
		<h3>Actions</h3>
		<ul>
			<li><a href="http://www.designcouncil.org.uk/resources/case-study/gripple" target="_blank" rel="noopener noreferrer">Business idea development case study on the Design Council website</a></li>
			<li><a href="http://www.bl.uk/business-and-ip-centre/start-your-business" target="_blank" rel="noopener noreferrer">Idea development resources on the British Library Business &amp; IP Centre website</a></li>
			<li><a href="#">Business viability assessment tool on the Venture Navigator website (registration required)</a></li>
			<li><a href="http://www.designcouncil.org.uk/news-opinion/qa-paul-priestman-product-design" target="_blank" rel="noopener noreferrer">Product design advice on the Design Council website</a></li>
			<li><a href="#">Socially responsible innovation information on the 3TU.Centre for Ethics and Technology website</a></li>
