...
<div class="row">
	<div class="small-12 large-8 large-push-4 columns">
		...
		<h2>Sources and contacts to help you start a business</h2>
		<p>There is a wide range of government support available to businesses, not only through grants and other funding but also through numerous advisory, guidance, information and other services, including training. See our guide on <a href="/finance-and-grants/finance-options/grants-and-government-support/government-support-for-businesses.php">government support for businesses</a>.</p>
		<p>Grants and loans are available to some businesses. <a href="https://www.gov.uk/growing-your-business" target="_blank" rel="noopener noreferrer">Search our business support finder for grants, loans, expertise and advice for which your business may be eligible</a>.</p>
		<p>There are different organisations which specialise in offering advice and/or financial help to different types of entrepreneur, for example:</p>
		<p>If you are over the age of 50, Prime offers you free information, advice and training to help you start up a business. You can <a href="#">find practical advice on starting a business on the Prime website</a>.</p>
		...
		<p>If you need to improve your business skills before or after starting a business, you can apply for a Professional and Career Development Loan. <a href="https://www.gov.uk/career-development-loans/overview" target="_blank" rel="noopener noreferrer">Find out about Professional and Career Development Loans on the Directgov website</a>.</p>
		
		<ul>
			<li><a href="/starting-up/considering-starting-up/starting-a-business-when-economic-conditions-are-tough/minimise-costs-and-maximise-efficiency.php" title="Minimise costs and maximise efficiency">Prev</a></li>
			<li><a href="/starting-up/considering-starting-up/starting-a-business-when-economic-conditions-are-tough/here-is-how-I-started-a-business-during-an-economic-downturn_flash-video.php" title="Here's how I started a business during an economic downturn (Flash video)">Next</a></li>
		</ul>
