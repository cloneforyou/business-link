...
<body>
	...
	<div class="row">
		<div class="small-12 large-8 large-push-4 columns">
			...
			<h2>Patents</h2>
			<p>Patents are a valuable form of intellectual property, and like all property, you should protect them. If you have a patent and someone uses it without permission, you have the right to claim for compensation.</p>
			<p>Applying for a patent can be complicated, and some products need to be protected by a number of different patents. You may need to use a patent agent to help present the application and make sure you are not infringing anyone else's intellectual property rights.</p>
			<p>For more information, see our guide on how to <a href="/create-innovate-and-protect/protecting-your-intellectual-property/patent-protection-and-your-business/get-patent-protection-for-your-business.php">get patent protection for your business</a>.</p>
			<p>You may be able to use someone else's patent with permission.</p>
			
			<ul>
				<li><a href="/starting-up/protect-your-business-ideas/intellectual-property-the-basics/how-you-can-protect-your-intellectual-property.php" title="How you can protect your intellectual property">Prev</a></li>
				<li><a href="/starting-up/protect-your-business-ideas/intellectual-property-the-basics/copyright.php" title="Copyright">Next</a></li>
			</ul>
