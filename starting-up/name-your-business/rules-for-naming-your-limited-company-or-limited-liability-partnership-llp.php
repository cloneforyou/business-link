...
<div class="row">
	<div class="small-12 large-8 large-push-4 columns">
		...
		<h2>Introduction</h2>
		<p>The name of your limited company or LLP must conform to certain regulations. If you choose a name that does not meet these requirements, you will not be able to use it.</p>
		<p>This guide provides guidance on how to choose a name and gives examples of the controls which apply to prescribed and other sensitive words.</p>
		
		<ul>
			<li><a href="/starting-up/name-your-business/rules-for-naming-your-limited-company-or-limited-liability-partnership-llp/choosing-a-name-for-a-company-or-llp.php" title="Choosing a name for a company or LLP">Next</a></li>
		</ul>
