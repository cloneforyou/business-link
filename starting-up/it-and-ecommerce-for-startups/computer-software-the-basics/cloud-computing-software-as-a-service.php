...
<html class="no-js">
<head>
	<title>Cloud computing - software as a service | Business Link</title>
	<?php include $_SERVER['DOCUMENT_ROOT'].'/_inc/meta.php'; ?>

	<!-- ref: detailccf0.html || /detail?itemId=1084673576&type=RESOURCES -->
	<meta name="description" lang="en" content="Information on cloud computing and how it can support your software requirements" />
...
<div class="row">
	<div class="small-12 large-8 large-push-4 columns">
		...
		<h2>Cloud computing - software as a service</h2>

		<p>Cloud computing lets you file and access documents, emails, customer information, business applications and other assets are all stored online - 'in the cloud'. This makes them accessible from any computer or mobile device with an internet connection and a web browser.</p>
		<p>Cloud computing is very flexible. It can help you make the most of a limited IT budget, while giving you access to the latest technology and professional support. However, there are also some potential disadvantages it is important to consider before making a final decision. For more information see our guide on <a href="/it-and-ecommerce/software-and-business-applications/cloud-computing.php">cloud computing</a>.</p>
		
		<ul>
			<li><a href="/starting-up/it-and-ecommerce-for-startups/computer-software-the-basics/licences-for-proprietary-software.php" title="Licences for proprietary software">Prev</a></li>
			<li><a href="/starting-up/it-and-ecommerce-for-startups/computer-software-the-basics/choosing-and-buying-software.php" title="Choosing and buying software">Next</a></li>
		</ul>
		...
		<ul>
			...
			<li>Cloud computing - software as a service </li>
		...
		<h3>Actions</h3>
		<ul>
			<li><a href="https://www.salesforce.com/cloudcomputing/" target="_blank" rel="noopener noreferrer">What is cloud computing?</a></li>
			<!-- <li><a href="http://www.allthingscrm.com/crm-basics/why-you-should-know-about-cloud-computing.html" target="bgExternalonlinebusinesslinkgovuk" title="Hardware and software needed for cloud computing">Cloud computing principles explained on the AllThingsCRM website</a></li> -->
		</ul>
		...
		<ul>
			...
			<li><a href="/it-and-ecommerce/data-protection-and-legal-issues/comply-with-data-protection-legislation.php">Comply with data protection legislation</a></li>
