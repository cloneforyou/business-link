...
<div class="row">
	<div class="small-12 large-8 large-push-4 columns">
		...
		<h2>Complaining about disqualified directors, undischarged bankrupts and persons subject to bankruptcy restrictions</h2>
		<p>If you report any evidence of a breach by a disqualified director, an undischarged bankrupt or a person subject to bankruptcy restrictions to The Insolvency Service, you should provide the following information if you know it:</p>
		<ul>
			<li>the name of the person you are complaining about</li>
			<li>details of any company that the person is involved with</li>
			<li>details of any credit the person has obtained</li>
			<li>details of any failure by the person to disclose their bankruptcy name</li>
			<li>your own name and details</li>
			<li>your company's details, if you are complaining on behalf of one</li>
		...
		Conduct and Complaints Team Hotline<br />
		3rd Floor<br />
		Cannon House<br />
