...
<head>
	<title>Complain against an insolvency practitioner or The Insolvency Service | Business Link </title>
	<?php include $_SERVER['DOCUMENT_ROOT'].'/_inc/meta.php'; ?>
	<!-- ref: x_x.html || /layer?topicId=1084608562 -->
	<meta name="description" content="How to make a formal complaint against The Insolvency Service if you are unhappy with the service received " />
	<meta name="keywords" content="Insolvency Service complaints Insolvency Service;insolvency practitioner;IP;creditors;Debtors;complaint;Redundancy Payments Office;RPO;Companies Investigation Branch;CIB;Adjudicator;Adjudicator's Office;Official Receiver;Redundancy Payment Services;director of redundancy payments;inspector of companies;Corporate Business Services;booklet AO6;Parliamentary and Health Service Ombudsman;PHSO;liquidator;trustee in bankruptcy;administrative receiver;Insolvency Practitioner Unit;ICAEW;IPA;ICAS;ICAI;LCS;IPC " />
</head>
...
<div class="row">
	<div class="small-12 large-8 large-push-4 columns">
		...
		<h1>Complain against an insolvency practitioner or The Insolvency Service</h1>
		<h2>Introduction</h2>
		<p>Insolvency issues, such as disqualifying company directors of insolvent companies and paying redundancy to employees of insolvent companies, are the responsibility of The Insolvency Service. It runs the official receiver network throughout England and Wales and administers and investigates the affairs of partnerships and companies wound up by the courts, as well as those of bankrupt individuals.</p>
		<p>If you are not happy with the way The Insolvency Service handled your case or are dissatisfied with the services you received, you should submit a formal complaint to the appropriate office within The Insolvency Service. If they fail to resolve your complaint sufficiently, you may be able to make a formal complaint to the relevant complaints commissioner.</p>
		<p>You can also make a formal complaint if you are not happy about the conduct of an insolvency practitioner (IP) - either directly to the IP concerned, or to the appropriate authorising body.</p>
		<p>This guide explains the complaints process for both The Insolvency Service and an IP.</p>
		
		<ul>
			<li><a href="/finance-and-grants/complain-against-an-insolvency-practitioner-or-the-insolvency-service/complaints-against-the-insolvency-service.php" title="Complaints against The Insolvency Service">Next</a></li>
		</ul>
		...
		<p>Developed with:<br />
			<a href="https://www.gov.uk/government/organisations/insolvency-service" target="_blank" rel="noopener noreferrer">
				<img src="/_img/InsolvencyServiceLogo.jpg" width="132" height="53" alt="" /> The Insolvency Service
			</a>
		</p>
