...
<html class="no-js">
<head>
	<title>Cashflow management: the basics | Business Link</title>
	<?php include $_SERVER['DOCUMENT_ROOT'].'/_inc/meta.php'; ?>

	<!-- ref: x_x.html || /layer?topicId=1073924763 -->
	<meta name="description" content="How to manage your cashflow and avoid cash problems in your business" />
	<meta name="keywords" content="Cashflow management; start up;new business;cash management;cashflow forecast;cash flow forecasting;interest costs;improve cash flow;cashflow chart;overtrading;financial planning;budgeting;credit control;payment terms;management accounting;cashflow projection;cash book;cash flow statement;cashflow management;accounting software;money management; Risk management" />
</head>
...
<body>
	...
	<div class="row">
		...
		<h1>Cashflow management: the basics</h1>
		<h2>Introduction</h2>
		
		<img src="/_img/FB0230.gif" width="94" height="62" alt="" />
		<p>Managing your cashflow is vital for business survival and growth. To run your business effectively, you need to balance the timing and amount of your costs with those of your income.</p>
		<p>This guide explains the various areas you need to consider when managing and improving cashflow in your business, including dealing with customers, suppliers and stakeholders, and using a cashflow forecast to plan your spending and assess potential risks in your cashflow.</p>

		<ul>
			<li><a href="/finance-and-grants/manage-your-cashflow/cashflow-management-the-basics/how-to-measure-cash-in-your-business.php" title="How to measure cash in your business">Next</a></li>
		</ul>
